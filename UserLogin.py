...
class User_Widget(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        app_icon.addFile('analytic-icon.png', QtCore.QSize(16,16))
        app_icon.addFile('analytic-icon.png', QtCore.QSize(24,24))
        app_icon.addFile('analytic-icon.png', QtCore.QSize(32,32))
        app_icon.addFile('analytic-icon.png', QtCore.QSize(48,48))
        app_icon.addFile('analytic-icon.png', QtCore.QSize(256,256))
        ...
        pic.setPixmap(QtGui.QPixmap("login.png"))
    ...
    def authenticate_user(self):
        try:
            ...
            # dbconnect.user = str(self.UserLine.text())
            # dbconnect.passwrd = str(self.Orcl_PassLine.text())
            ...
            QtGui.QMessageBox.warning(
                  self, 'Error', 'Please insert correct userid or password')
        # except cx_Oracle.DatabaseError :
        #     QtGui.QMessageBox.warning(
        #           self, 'Error', 'Wrong Oracle userid or password')
