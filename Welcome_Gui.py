...
class Ui_MainWindow(QtGui.QMainWindow):
    def __init__(self, parent=None, user = None, passwrd = None):
        ...
        self.action_DataBase = QtGui.QAction(QtGui.QIcon('database.png'), "Database", self)
        self.action_DataBase.setObjectName(_fromUtf8("action_DataBase"))
        self.action_DataBase.setShortcut("Ctrl+D")

        self.action_Graphs = QtGui.QAction(QtGui.QIcon('graph.ico'), "Graph", self)
        ...
        self.actionQuit = QtGui.QAction(QtGui.QIcon('exit24.png'), "Exit", self)
